// login-test.js
// Playwright script to open Admin-FE, perform login, and print localStorage.tea_admin_token
// Usage:
// 1) Install deps: npm install
// 2) Install browsers: npx playwright install
// 3) Run: ADMIN_FE_URL=http://localhost:8000 TEST_USER=admin TEST_PASS=pass node login-test.js
